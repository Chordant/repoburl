...
**********************************************************************************************************/
		...
		function seos_music_mb_pagination() {
			...
			$big = 242425757; // need an unlikely integer
			...
			class Seos_Music_Customize extends WP_Customize_Control {
				...
				<div class="seos_business-info"> 
					<button class="button media-button button-primary button-large media-button-select">
						<a href="<?php echo esc_url( 'http://seosthemes.com/seos-music/' ); ?>" title="<?php esc_attr_e( 'Seos Music Buy', 'seos-music' ); ?>" target="_blank">
